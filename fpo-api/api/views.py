...
from api.efiling import generate_efiling_url
...
class SubmitFormView(generics.GenericAPIView):
    def get(self, request):
        ...
        return Response({"efilingUrl": None})
